...
class ToDoCardState extends State<ToDoCard> {
  ...
  List colorList = const [
    Color.fromRGBO(241, 206, 206, 1),
    Color.fromRGBO(200, 211, 237, 1),
    Color.fromRGBO(239, 238, 209, 1),
    Color.fromRGBO(240, 207, 240, 1),
    Color.fromRGBO(198, 235, 232, 1),
    Color.fromRGBO(237, 210, 230, 1),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(fit: StackFit.expand, children: [
        Image.network(
            "https://www.shutterstock.com/image-vector/kid-question-mark-curious-vector-600nw-1474586489.jpg",
            fit: BoxFit.cover),
        Padding(
